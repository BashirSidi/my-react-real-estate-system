...
export function withSentryConfig(providedExports, providedWebpackPluginOptions) {
    ...
    return __assign(__assign({}, providedExports), { experimental: __assign(__assign({}, (providedExports.experimental || {})), { plugins: true }), plugins: __spread((providedExports.plugins || []), ['@sentry/next-plugin-sentry']), productionBrowserSourceMaps: true, webpack: function (originalConfig, options) {
            ...
            new SentryWebpackPlugin(__assign(__assign({ dryRun: options.dev }, defaultWebpackPluginOptions), providedWebpackPluginOptions)));
            return config;
        } });
}
try {
