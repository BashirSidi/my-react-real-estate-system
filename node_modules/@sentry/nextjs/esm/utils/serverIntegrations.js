...
export var defaultRewriteFrames = new RewriteFrames({
 ...
 */
export function getFinalServerIntegrations(userIntegrations) {
...
function getFinalIntegrationArray(userIntegrations) {
    if (userIntegrations.map(function (integration) { return integration.name; }).includes(defaultRewriteFrames.name)) {
