...
import { getTranslatedName, getTranslatedSizeUnit } from 'utilities/market';
      ...
      >
        <Box className={classes.root}>
          ...
          <Box className={classes.imagecontainer}>
            <img src={spaceType?.gif_large} alt="" className={classes.spaceTypeImage} />
          </Box>
          <Box className={classes.details}>
            ...
            <Typography className={classes.size}>
              ...
              {' '}
              { !spaceType?.is_locker && getTranslatedSizeUnit(spaceType?.unit, locale) }
            </Typography>
                ...
                <Typography className={classes.priceText}>
                  <span className={classes.price}>
                    ...
                    {new Intl.NumberFormat(router.defaultLocale)
                      .format(spaceType?.spaces?.edges?.[0]?.prices?.[0]?.price_per_month)}
                  </span>
                  /
                  {t('typography2')}
                </Typography>
