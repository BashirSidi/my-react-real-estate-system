...
export interface GetCustomerInvoiceQuery_customer_invoice_promotion {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface GetCustomerInvoiceQuery_customer_invoice {
  ...
  sub_total_amount: number | null;
  deposit_amount: number | null;
  promotion: GetCustomerInvoiceQuery_customer_invoice_promotion | null;
