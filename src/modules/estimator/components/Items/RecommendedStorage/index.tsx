...
import { useCurrentCountry, useSizeUnitT } from '../../../../../utilities/market';
import { ISpaceType } from '../../../../../shared/interfaces';

interface IProps {
  size: number;
  setSpaceTypeId: (id: number) => void,
  setSpaceType: (ISpaceType: ISpaceType) => void;
}
...
const RecommendedStorage: FC<IProps> = ({ size, setSpaceTypeId, setSpaceType }) => {
