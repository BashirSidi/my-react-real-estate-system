...
export interface ReservationDetailQuery_booking_original_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface ReservationDetailQuery_booking_original_site_address {
  ...
  district: ReservationDetailQuery_booking_original_site_address_district | null;
}
...
export interface ReservationDetailQuery_booking_quotation_item_quotation {
  uuid: string;
}

export interface ReservationDetailQuery_booking_quotation_item {
  quotation: ReservationDetailQuery_booking_quotation_item_quotation | null;
}
...
export interface ReservationDetailQuery_booking {
  ...
  quotation_item: ReservationDetailQuery_booking_quotation_item | null;
}
