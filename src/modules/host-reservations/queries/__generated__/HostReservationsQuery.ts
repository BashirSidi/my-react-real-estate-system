...
export interface HostReservationsQuery_bookings_edges_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface HostReservationsQuery_bookings_edges_site_address {
  ...
  district: HostReservationsQuery_bookings_edges_site_address_district | null;
}

export interface HostReservationsQuery_bookings_edges_space_features {
  icon: string | null;
  name_en: string;
  name_th: string;
  name_jp: string;
...
export interface HostReservationsQuery_bookings_edges_original_space {
  name: string | null;
  images: string[] | null;
}
...
export interface HostReservationsQuery_bookings_edges {
  ...
  space_features: HostReservationsQuery_bookings_edges_space_features[];
  original_space: HostReservationsQuery_bookings_edges_original_space | null;
  total_amount: number;
