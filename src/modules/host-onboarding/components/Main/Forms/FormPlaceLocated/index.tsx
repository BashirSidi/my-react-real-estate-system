...
const FormPlaceLocated = (props: IProps) => {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      lat: { val: address?.lat || 0, errorClass: '', isRequired: true },
      lng: { val: address?.lng || 0, errorClass: '', isRequired: true },
    });
  ...
  const handleChangeStreet = (street) => {
    setFormVal('street', { ...form.street, val: street?.substring(0, 254) });
  };
        ...
        <form onSubmit={handleSubmit}>
          <Box className={classes.paddingRight}>
            ...
            <LocationSelect
              ...
              error={t('grey3Typography8', { variable: t('label1') })}
            />
            ...
            <LocationSelect
              ...
              error={t('grey3Typography8', { variable: t('label2') })}
            />
            ...
            <Box className={classes.inputBox}>
              ...
              {form.street.errorClass && (
              <p className={classes.textError}>
                {t('grey3Typography8', { variable: t('grey3Typography5') })}
              </p>
              )}
            </Box>
            <Box>
              ...
              <Grid item md={6} xs={12}>
                <Box>
                  ...
                  <Box className={classes.inputBox}>
                    ...
                    />
                    {form.postal_code.errorClass && (
                    <p className={classes.textError}>
                      {t('grey3Typography8', { variable: t('grey3Typography7') })}
                    </p>
                    )}
                  </Box>
                  <Box>
