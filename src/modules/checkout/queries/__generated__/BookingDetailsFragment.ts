...
export interface BookingDetailsFragment_original_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface BookingDetailsFragment_original_site_address {
  ...
  district: BookingDetailsFragment_original_site_address_district | null;
}
...
export interface BookingDetailsFragment_quotation_item_quotation {
  uuid: string;
}

export interface BookingDetailsFragment_quotation_item {
  quotation: BookingDetailsFragment_quotation_item_quotation | null;
}
...
export interface BookingDetailsFragment {
  ...
  quotation_item: BookingDetailsFragment_quotation_item | null;
}
