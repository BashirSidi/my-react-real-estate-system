...
export interface CreateBooking_createBooking_original_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface CreateBooking_createBooking_original_site_address {
  ...
  district: CreateBooking_createBooking_original_site_address_district | null;
}
...
export interface CreateBooking_createBooking_quotation_item_quotation {
  uuid: string;
}

export interface CreateBooking_createBooking_quotation_item {
  quotation: CreateBooking_createBooking_quotation_item_quotation | null;
}
...
export interface CreateBooking_createBooking {
  ...
  quotation_item: CreateBooking_createBooking_quotation_item | null;
