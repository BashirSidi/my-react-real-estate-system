...
import { FixedCountry, SpaceStatus, SpaceSizeUnit, PriceType, StockManagementType } from "./../../../../typings/graphql.types";
...
export interface GetSpaceQuery_spaces_edges_site_address {
  district: GetSpaceQuery_spaces_edges_site_address_district | null;
}
