...
export interface GetBookingDetailsQuery_booking_original_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface GetBookingDetailsQuery_booking_original_site_address {
  ...
  district: GetBookingDetailsQuery_booking_original_site_address_district | null;
}
...
export interface GetBookingDetailsQuery_booking_quotation_item_quotation {
  uuid: string;
}

export interface GetBookingDetailsQuery_booking_quotation_item {
  quotation: GetBookingDetailsQuery_booking_quotation_item_quotation | null;
}
...
export interface GetBookingDetailsQuery_booking {
  ...
  quotation_item: GetBookingDetailsQuery_booking_quotation_item | null;
}
