...
export interface GetBookingQuery_booking_original_site_address_district {
  name_en: string;
  name_th: string;
  name_jp: string;
  name_kr: string;
...
export interface GetBookingQuery_booking_original_site_address {
  ...
  district: GetBookingQuery_booking_original_site_address_district | null;
}
...
export interface GetBookingQuery_booking_quotation_item_quotation {
  uuid: string;
}

export interface GetBookingQuery_booking_quotation_item {
  quotation: GetBookingQuery_booking_quotation_item_quotation | null;
}
...
export interface GetBookingQuery_booking {
  ...
  quotation_item: GetBookingQuery_booking_quotation_item | null;
}
