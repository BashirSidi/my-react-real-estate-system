...
import { GetCustomerInvoiceQuery_customer_invoice_promotion } from '../../invoice/queries/__generated__/GetCustomerInvoiceQuery';
...
export type IPromotion = GetCustomerInvoiceQuery_customer_invoice_promotion;
