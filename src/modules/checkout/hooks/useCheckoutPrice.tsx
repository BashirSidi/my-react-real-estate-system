...
import {
  PickupServiceDetailsCheckoutPricePayload,
  PromotionStatus, TaxEntityType, TaxType,
} from '../../../typings/graphql.types';

import { CALCULATE_PRICE } from '../queries';
import {
  CalculateBookingPrice,
  CalculateBookingPriceVariables,
} from '../queries/__generated__/CalculateBookingPrice';
