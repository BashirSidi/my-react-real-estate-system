...
export enum QuotationSpaceSize {
  L = "L",
  M = "M",
  S = "S",
  XL = "XL",
...
export interface QuotationIdFilter {
  _eq?: string | null;
}
...
export interface SiteLocationFilter {
  distance: NumberFilter;
  longitude: NumberFilter;
  latitude: NumberFilter;
}

export interface SiteStatusFilter {
  _eq?: SiteStatus | null;
  _in?: SiteStatus[] | null;
}

export interface SitesFilter {
  id?: EntityIdFilter | null;
  platform_space_type_id?: EntityIdFilter | null;
  site_platform_feature_id?: EntityIdFilter | null;
  space_platform_feature_id?: EntityIdFilter | null;
  price?: PriceFilter | null;
  name?: StringFilter | null;
  status?: SiteStatusFilter | null;
  stock_management_type?: StockManagementFilter | null;
  country_id?: EntityIdFilter | null;
  country?: CountryFilter | null;
  province_id?: EntityIdFilter | null;
  city_id?: EntityIdFilter | null;
  district_id?: EntityIdFilter | null;
  is_featured?: boolean | null;
  location?: SiteLocationFilter | null;
  quotation_id?: QuotationIdFilter | null;
}

export interface StockManagementFilter {
  _eq?: StockManagementType | null;
  _in?: StockManagementType[] | null;
}
