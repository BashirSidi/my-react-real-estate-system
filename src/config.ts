...
const DOOR_TO_DOOR_PRICE = 15;
const GOGOX_CAPACITY = {
  van: ['Locker', 'XXS', 'XS'],
  lorry10: ['Locker', 'XXS', 'XS', 'S'],
  lorry14: ['Locker', 'XXS', 'XS', 'S', 'M'],
  lorry24: ['Locker', 'XXS', 'XS', 'S', 'M', 'L', 'XL', 'XXL'],
};

const GOGOX_RECOMMENDATION = {
  van: ['Locker', 'XXS', 'XS'],
  lorry10: ['S'],
  lorry14: ['M'],
  lorry24: ['L', 'XL', 'XXL'],
...
const TOKYO_CITY_ID = 140;
const BOX_TO_BOX = 'Box to Box';
const BRANCH_SDK_KEY = process.env.NEXT_PUBLIC_BRANCH_SDK_KEY;
const INTERCOM_APP_ID = process.env.NEXT_PUBLIC_INTERCOM_APP_ID;
const FLAGSMITH_API_KEY = process.env.NEXT_PUBLIC_FLAGSMITH_API_KEY;
const PRISMIC_ACCESS_TOKEN = process.env.NEXT_PUBLIC_PRISMIC_ACCESS_TOKEN;
export {
