...
import { CLEVERTAP_ACCOUNT_ID, FLAGSMITH_API_KEY } from '../config';
...
import { client } from '../utilities/prismic';
...
class MyApp extends App<Props> {
  ...
  render(): JSX.Element {
    ...
    const {
      apollo, dataStore, authStore, sitesStore, store,
    } = this.state;
    ...
    return (
      <FlagsmithProvider environmentId={FLAGSMITH_API_KEY}>
