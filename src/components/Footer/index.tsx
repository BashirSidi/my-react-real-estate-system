...
const Footer: FC<IProps> = ({ auth }) => {
  ...
  const sendCleverTap = () => {
    const trackingPayload = {
      ...
      status: '',
      siteName: 'social-link-whatsapp',
      country: country.name,
    };
    const eventName = IEventName.WHATSAPP_CLICKED;
          ...
          <Box className={classes.actions}>
            ...
            <Box className={classes.social}>
              {country.socialLink.whatsapp
                && (
                  <a href={country.socialLink.whatsapp} rel="noreferrer" target="_blank" onClick={sendCleverTap}>
